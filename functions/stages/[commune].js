...
const PILOT_COMMUNES = {
  "liege": { display: "Liège", region: "Wallonie", dbValues: ["Liège", "Liege"] },
  "uccle": { display: "Uccle", region: "Bruxelles", dbValues: ["Uccle"] },
  "woluwe-saint-pierre": { display: "Woluwe-Saint-Pierre", region: "Bruxelles", dbValues: ["Wol.-St-Pierre"] },
  "woluwe-saint-lambert": { display: "Woluwe-Saint-Lambert", region: "Bruxelles", dbValues: ["Wol.-St-Lambert"] },
  "etterbeek": { display: "Etterbeek", region: "Bruxelles", dbValues: ["Etterbeek"] },
  "wavre": { display: "Wavre", region: "Wallonie", dbValues: ["Wavre"] },
  "mons": { display: "Mons", region: "Wallonie", dbValues: ["Mons"] },
  "charleroi": { display: "Charleroi", region: "Wallonie", dbValues: ["Charleroi"] },
  "nivelles": { display: "Nivelles", region: "Wallonie", dbValues: ["Nivelles"] },
  "herstal": { display: "Herstal", region: "Wallonie", dbValues: ["Herstal"] },
};
